...
public class GreaterThanEqualVersionTest 
{
  ...
  public void test_valid()
  {
    ...
    Assertions.assertTrue(requiredVersion.isValid(versionMajor));
  }
  ...
  {
    RequiredVersion requiredVersion = Modules.parseRequiredVersion(">=" + versionString);
    Assertions.assertFalse(requiredVersion.isValid(versionMinor));
  }
